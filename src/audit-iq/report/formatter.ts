...
export function formatFullReport(report: AuditReport): string {
    ...
    lines.push(`**Industry:** ${report.company.industry} | **Stage:** ${report.company.stage} | **Team Size:** ${report.company.teamSize}`);
    lines.push(``);
    lines.push(`---`);
    lines.push(``);
    lines.push(`## Overall Score: ${report.compositeScore}/100 — Grade: ${report.compositeGrade}`);
    lines.push(``);
    ...
    for (const d of report.dimensions) {
        ...
        lines.push(`| ${d.dimension.charAt(0).toUpperCase() + d.dimension.slice(1)} | ${d.score}/100 | ${d.grade} | ${crit} | ${warn} |`);
    }
    lines.push(``);
    lines.push(`---`);
    lines.push(``);
    ...
    lines.push(`---`);
    lines.push(`*Report generated by X AuditIQ — powered by the AI Council Conductor methodology.*`);
