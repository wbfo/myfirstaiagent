...
export function scoreTeam(brief: AuditBrief): DimensionScore {
    ...
    if (brief.team.hasSinglePointOfFailure) {
        ...
        findings.push({
            ...
            remediation: "Cross-train a backup for the critical role. Document their knowledge in an SOP within 14 days.",
        });
    }
    ...
    if (!brief.team.hasOrChart) {
        ...
        findings.push({
            ...
            remediation: "Build a one-page org chart, even for a 3-person team. Include decision authority.",
        });
    }
    ...
    if (culture !== undefined && culture <= 2) {
        ...
        findings.push({
            ...
            remediation: "Conduct a 15-minute anonymous team survey. Address the top-rated issue within 30 days.",
        });
    }
