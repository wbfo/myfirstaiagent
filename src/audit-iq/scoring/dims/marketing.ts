...
export function scoreMarketing(brief: AuditBrief): DimensionScore {
    ...
    if (!brief.marketing.hasIcp) {
        ...
        findings.push({
            ...
            detail: "Without an ICP, every sales and marketing dollar is partially wasted on the wrong audience.",
            remediation: "Define your ICP this week: company size, industry, pain point, budget, and decision-maker title.",
        });
    }
    ...
    if (!brief.marketing.hasRepeatableAcquisition) {
        ...
        findings.push({
            ...
            remediation: "Document your current best-performing channel and build a 5-step repeatable playbook around it.",
        });
    }
    ...
    if (brand === "none") {
        ...
        findings.push({
            ...
            detail: "Unknown brands require more outreach effort per close. Brand investment compounds over time.",
        });
    }
