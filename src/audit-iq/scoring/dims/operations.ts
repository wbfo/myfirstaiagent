...
export function scoreOperations(brief: AuditBrief): DimensionScore {
    ...
    if (!brief.operations.hasDocumentedProcesses) {
        ...
        findings.push({
            ...
            detail: "Key operations rely on tribal knowledge. One departure disrupts the entire workflow.",
    ...
    if (!brief.operations.hasAutomation) {
        ...
        findings.push({
            ...
            remediation: "Identify 1–2 high-frequency manual tasks and automate them with Zapier, Make, or custom scripts.",
        });
    }
